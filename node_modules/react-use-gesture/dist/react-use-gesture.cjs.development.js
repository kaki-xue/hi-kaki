...
var DragRecognizer = /*#__PURE__*/function (_CoordinatesRecognize) {
  ...
  function DragRecognizer(controller, args) {
    ...
    _this.dragShouldStart = function (event) {
      ...
      _this.isTouch = !!touches; // If the previous gesture was touch-based, and the current one is mouse based,
      ...
      if (!_this.controller.config.pointer && _this.wasTouch && !_this.isTouch) {
    ...
    _this.setListeners = function () {
      ...
      var dragListeners = _this.isTouch ? [['touchmove', _this.onDragChange], ['touchend', _this.onDragEnd]] : [['touchcancel', _this.onDragEnd], ['mousemove', _this.onDragChange], ['mouseup', _this.onDragEnd]];
...
//# sourceMappingURL=react-use-gesture.cjs.development.js.map
